...
assessmentButton.onclick = function(){
  ...
  const hrefValue = 'https://twitter.com/intent/tweet?button_hashtag=あなたのいいところ&ref_src=twsrc%5Etfw" class="twitter-hashtag-button';
...
userNameImput.onkeydown = function(event) {
  if (event.key === 'Enter') {
    // ボタンのonclick() 処理を呼び出す
